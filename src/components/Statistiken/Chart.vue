...
export default {
  ...
  series: this.series
   ...
   series() {
       ...
       this.chartData.children.forEach((item,idx)=>{
          ...
          if (idx === 0) {
           series.push({"name":item.prefLabel,"data":data, color:"#C6C2BC"})
            ...
            else series.push({"name":item.prefLabel,"data":data, visible:false})
          })
       ...
       let totalSeries = {"name":"Gesamt","type":"line","stacking":false,"marker":{"enabled":false},"showInLegend":false,"color":"#FF0000",data:totals}
